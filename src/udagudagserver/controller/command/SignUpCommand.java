...
public class SignUpCommand implements Command {
	...
	public String execute() {
		...
		boolean success = Controller.getInstance().getMessengerDAO()
				.signUp(email, birthday, password, firstName, lastName, place, state);
		SignUpBackCommandData signUpBackCommandData = new SignUpBackCommandData(success);
