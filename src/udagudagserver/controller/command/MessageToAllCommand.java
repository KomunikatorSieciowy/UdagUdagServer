...
public class MessageToAllCommand implements Command {
	...
	public String execute() {
		...
		MessageBackCommandData messageBackCommandData = new MessageBackCommandData(message);
		...
		MessageToAllBackCommandData messageToAllBackCommandData = new MessageToAllBackCommandData(success);
